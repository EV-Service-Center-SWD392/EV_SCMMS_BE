...
public partial class AppDbContext : DbContext
{
    ...
    public virtual DbSet<Paymentcuongtq> Paymentcuongtqs { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Orderthaontt>(entity =>
        {
            ...
            entity.HasOne(d => d.Payment).WithMany(p => p.Orderthaontts)
                .HasForeignKey(d => d.Paymentid)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("orderthaontt_paymentid_fkey");
        ...
        modelBuilder.Entity<Paymentcuongtq>(entity =>
        {
            entity.HasKey(e => e.Paymentid).HasName("paymentcuongtq_pkey");

            entity.ToTable("paymentcuongtq");
        ...
        modelBuilder.Entity<Receiptcuongtq>(entity =>
        {
            ...
            entity.HasIndex(e => e.Orderid, "receiptcuongtq_orderid_key").IsUnique();
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.ReceiptcuongtqCustomers)
                .HasForeignKey(d => d.Customerid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("receiptcuongtq_customerid_fkey");

            entity.HasOne(d => d.Order).WithOne(p => p.Receiptcuongtq)
                .HasForeignKey<Receiptcuongtq>(d => d.Orderid)
                .HasConstraintName("receiptcuongtq_orderid_fkey");

            entity.HasOne(d => d.Staff).WithMany(p => p.ReceiptcuongtqStaffs)
                .HasForeignKey(d => d.Staffid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("receiptcuongtq_staffid_fkey");
        });
